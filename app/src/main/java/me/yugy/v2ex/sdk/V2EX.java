...
public class V2EX {
    ...
    public static void getLatestTopics(Context context, int page, JsonHttpResponseHandler responseHandler){
        DebugUtils.log("getLatestTopics");
        RequestParams params = new RequestParams();
        params.put("p", String.valueOf(page));
        new AsyncHttpClient().get(context, API_URL + API_LATEST, params, responseHandler);
    }

    public static void getAllNode(Context context, JsonHttpResponseHandler responseHandler){
        DebugUtils.log("getAllNode");
        new AsyncHttpClient().get(context, API_URL + API_ALL_NODE, responseHandler);
    }
